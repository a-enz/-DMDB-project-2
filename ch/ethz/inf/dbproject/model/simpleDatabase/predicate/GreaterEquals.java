...
public class GreaterEquals implements Predicate{
	
	Extractor left;
	Extractor right;
	
	public GreaterEquals(Extractor left, Extractor right){
		this.left = left;
		this.right = right;
	}
	...
	public void printTree(int depth) {
		System.out.println(Helper.indent(depth) + "GreaterEqualsNode");
